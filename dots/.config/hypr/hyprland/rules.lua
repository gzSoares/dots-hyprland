...
hl.window_rule({match = {title = "^(Choose Files)(.*)$" },                   center = true})
...
hl.window_rule({match = {class = "^(io.github.diegopvlk.Cine)$" },                        float = true})
hl.window_rule({match = {class = "^(io.github.diegopvlk.Cine)$" },                        size = {"(monitor_w*0.45)", "(monitor_h*0.45)"} })
hl.window_rule({match = {class = "^(io.github.diegopvlk.Cine)$" },                        center = true})
hl.window_rule({match = {class = "^(org.kde.gwenview)$" },                        float = true})
hl.window_rule({match = {class = "^(org.kde.gwenview)$" },                        size = {"(monitor_w*0.25)", "(monitor_h*0.50)"} })
hl.window_rule({match = {class = "^(org.kde.gwenview)$" },                        center = true})
hl.window_rule({match = {class = "^(scrcpy)$"}, float = true})
hl.window_rule({match = {class = "^(scrcpy)$"}, size = {"(monitor_w*0.18)", "(monitor_h*0.45)"}})
hl.window_rule({match = {class = "^(scrcpy)$"}, move = {"(monitor_w*0.81)", "(monitor_h*0.54)"} })
hl.window_rule({match = {class = "^(mpv)$" },                        float = true})
hl.window_rule({match = {class = "^(mpv)$" },                        size = {"(monitor_w*0.25)", "(monitor_h*0.50)"} })
hl.window_rule({match = {class = "^(mpv)$" },                        center = true})
hl.window_rule({match = {class = "^(org.gnome.Calculator)$"}, float = true})
hl.window_rule({match = {class = "^(org.gnome.Calculator)$"}, size = {"(monitor_w*0.18)", "(monitor_h*0.45)"}})
hl.window_rule({match = {class = "^(org.gnome.Calculator)$"}, move = {"(monitor_w*0.81)", "(monitor_h*0.54)"} })
hl.window_rule({match = {class = "^(org.gnome.Calculator)$"}, pin = true})
